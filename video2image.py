...
def extract_frames(video_dir):
    ...
    save_dir = os.path.join(r"E:\ESD\ESD_Vessel_Frames", os.path.basename(video_dir))
...
if __name__ == "__main__":
    ...
    video_dirs = [r"E:\ESD\ESD_Vessel_Frames\{}_clipped".format(x) for x in data_names]
    # extract_frames(video_dirs[0])
    mpPool = mp.Pool(2)
